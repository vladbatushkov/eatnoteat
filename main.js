...
var $author$project$Main$foodPair = F3(
	function (food1, food2, foodState) {
		return A3(
			$surprisetalk$elm_bulma$Bulma$Columns$columns,
			_Utils_update(
				$surprisetalk$elm_bulma$Bulma$Columns$columnsModifiers,
				{centered: true, display: $surprisetalk$elm_bulma$Bulma$Columns$MobileAndBeyond, gap: $surprisetalk$elm_bulma$Bulma$Columns$Gap3}),
			_List_Nil,
			_List_fromArray(
				[
					A3(
					...
					_Utils_ap(
						...
						$mdgriffith$elm_style_animation$Animation$render(foodState)),
					_List_fromArray(
						[
...
var $author$project$Main$foodGrid = function (model) {
	var foods = $elm$core$Array$fromList(
		A2($elm$core$List$take, 4, model.food));
	...
	return A2(
		...
		_List_fromArray(
			[
				A3($author$project$Main$foodPair, food1, food2, model.foodState),
				A3($author$project$Main$foodPair, food3, food4, model.foodState)
			]));
};
var $surprisetalk$elm_bulma$Bulma$Elements$H1 = {$: 'H1'};
var $surprisetalk$elm_bulma$Bulma$Elements$H4 = {$: 'H4'};
var $surprisetalk$elm_bulma$Bulma$Elements$H5 = {$: 'H5'};
...
var $author$project$Main$healthContainer = function (hp) {
	var _v0 = hp.value;
	switch (_v0) {
		case 1:
			return _List_fromArray(
				[
					...
					_Utils_ap(
						...
						$mdgriffith$elm_style_animation$Animation$render(hp.state)),
					_List_fromArray(
...
var $author$project$Main$healthPanel = function (model) {
	return A3(
		$surprisetalk$elm_bulma$Bulma$Columns$columns,
		_Utils_update(
			$surprisetalk$elm_bulma$Bulma$Columns$columnsModifiers,
			{centered: false, display: $surprisetalk$elm_bulma$Bulma$Columns$MobileAndBeyond}),
		_List_Nil,
...
var $author$project$Main$gamePlay = F3(
	function (hero, hp, s) {
		return A2(
						...
						[
								...
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src(hero.picture),
													...
													_List_fromArray(
														[
															...
															A2($elm$html$Html$Attributes$style, 'bottom', '0rem'),
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(hero.name)
												])),
											$author$project$Main$healthPanel(hp)
										]))
								])),
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									$surprisetalk$elm_bulma$Bulma$Elements$H5,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text(hero.desc)
										]))
								]))
						]))
				]));
...
var $author$project$Main$body2 = function (model) {
	return A3(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('EatOrShit')
							])),
						$author$project$Main$foodGrid(model),
						A3($author$project$Main$gamePlay, model.hero, model.hp, model.score)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$body2(model)
			]));
};
